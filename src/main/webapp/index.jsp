...
<title>员工列表</title>
<%
	pageContext.setAttribute("APP_PATH", request.getContextPath());//一斜线开始，没有以斜线结尾的
%>
<!-- web路径：
      ...
      <div class="modal-body">
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@lxd.com">
      ...
      <div class="modal-body">
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label class="col-sm-2 control-label">email</label>
		    <div class="col-sm-10">
		      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@lxd.com">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
...
/* 			$("#empAddModal form")[0].reset(); */
		...
		//解决方法：创建按钮的时候绑定，2、绑定单击。live()
	    //新版的jquery没有live(),使用on进行替代
